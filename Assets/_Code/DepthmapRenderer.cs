...
public class DepthmapRenderer : MonoBehaviour {
	...
	public Vector3 size = new Vector3(256/75, 100/40, 192/75);


	void Start () {
		GenerateHeightmap();
		gameObject.transform.Rotate (eulerAngles: new Vector3 (-90, 180, 0));
	...
	{		
		...
		for (y=0;y<height;y++)
		{
			for (x=0;x<width;x++)
			{
				...
				Vector3 vertex = new Vector3 (x-width/2, pixelHeight, y-height/2);
